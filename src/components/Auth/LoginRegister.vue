<template>
    ...
    <form @submit.prevent="submitForm">
        ...
        <div class="row q-mb-md">
            ...
            <q-banner class="bg-grey-3 col">
                <template v-slot:avatar>
                    ...
                    {{ tab | titleCase }} to acess your Todos anywhere!        
            </q-banner>
        ...
        <div class="row q-mb-md">
            ...
            lazy-rules
            ref="email"
            v-model="formData.email" label="Email" type="email" stack-label />
        </div>

        <div class="row q-mb-md">
            <q-input class="col" 
            :rules="[val => val.length >= 6 || 'Please, enter at 6 characters']"
            lazy-rules
            ref="password"
